...
class _CustomStepperState extends State<CustomStepper>
  ...
  void initState() {
    ...
    itemsWithEnabledProgressLine =
        widget.steps.where((step) => step.isHeaderShow).toList();
    WidgetsBinding.instance.addPostFrameCallback(
        (duration) => _onStepContinueAnim(widget.currentStep));
  }
  ...
  void _onStepContinueAnim(int stepIndex) {
    final offset = (_headerProgressBarController.position.maxScrollExtent /
            itemsWithEnabledProgressLine.length) *
        (stepIndex + 1);
    _headerProgressBarController.animateTo(offset,
  ...
  void Function()? _onStepBackGenerator(int stepIndex) {
    ...
    return () {
      final scrollOffset =
          _headerProgressBarController.position.maxScrollExtent /
              itemsWithEnabledProgressLine.length;
