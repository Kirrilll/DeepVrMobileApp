...
class OrderPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
      ...
      //         crossAxisAlignment: CrossAxisAlignment.start,
      //         children: [
      //           Text(booking.selectedType!.title, style: TextStyle(
      //             fontSize: 24,
      //             color: Colors.white,
      //             fontWeight: FontWeight.w600
      //           )),
      //           Text(booking.selectedGame!.title, style: TextStyle(
      //               fontSize: 24,
      //               color: Colors.white,
      //               fontWeight: FontWeight.w600
      //           )),
      //           Text('Игроков: ${booking.guestCount}', style: TextStyle(
      //               fontSize: 24,
      //               color: Colors.white,
      //               fontWeight: FontWeight.w600
      //           )),
      //           Text(booking.selectedDate!.date.toString().replaceRange(
      //               10, booking.selectedDate!.date.toString().length, ''), style: TextStyle(
      //               fontSize: 24,
      //               color: Colors.white,
      //               fontWeight: FontWeight.w600
      //           )),
      //           Text(booking.selectedTime!.time, style: TextStyle(
      //               fontSize: 24,
      //               color: Colors.white,
      //               fontWeight: FontWeight.w600
      //           )),
